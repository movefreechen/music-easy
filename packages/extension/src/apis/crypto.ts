...
const aesEncrypt = (buffer: any, mode: string, key: Buffer | Uint8Array | string, iv: any) => {
...
const weapi = (object: any) => {
    ...
    const secretKey = crypto
        .randomBytes(16)
        .map((n: number) => base62.charAt(n % 62).charCodeAt(0))
    return {
        params: aesEncrypt(
            Buffer.from(
...
const eapi = (url: string, object: any) => {
